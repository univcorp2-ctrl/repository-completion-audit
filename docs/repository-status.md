...
|---:|---|---|---|---|---|
| 1 | repository-completion-audit | 監査ダッシュボード | 完了 / 運用可能 | success: 26711423678 | 今回この台帳を作成 |
...
| 11 | global-job-aggregator-mvp | グローバル求人収集MVP | 完了 / 運用可能 | CI success: 26711375511 / collect success: 26711389203 | collector/CLI/workflow修正済み |
...
| 23 | linkedin-ai-crowdworks-bot | LinkedIn/CrowdWorks bot | 要対応 | 未確認 | 利用規約・安全性確認が必要 |
